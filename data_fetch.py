...
'''
Please note: This is currently only set up to grab the last entry of data for 2020. You could technically set it up to 
grab every month's data for each year, but it appears successive sets of data are cumulative so there's not really a 
point to grabbing sets from earlier in the year. 2020 alone provides over 200000 kickstarter names and blurbs, more 
than enough for our RNN text generator to learn from.
'''
